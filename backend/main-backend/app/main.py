...
def _print_owned_domains_banner() -> None:
    ...
    print("domains: auth/users, weather")
    print("routes: /api/v1/auth, /api/v1/users, /api/v1/weather")
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Canonical surface: /api/v1/auth, /api/v1/users, /api/v1/weather",
